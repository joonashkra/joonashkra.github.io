...
function NavBar() {
    ...
    return (
        <div className="flex items-center bg-black/25 py-6 justify-center sm:justify-between">
            <h1 className='text-xl sm:text-2xl ml-20 flex items-center gap-8'>joonashkra.github.io</h1>
