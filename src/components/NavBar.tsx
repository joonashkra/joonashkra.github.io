...
function NavBar() {
  ...
  return (
    <div className="navBar bg-white dark:bg-black shadow-md shadow-black/15 p-4 md:p-6 flex flex-col md:flex-row md:justify-around md:items-center w-full sticky top-0 z-50">
