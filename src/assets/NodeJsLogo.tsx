...
const SvgComponent = ({size=24}) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2249 2249" width={size} height={size}>
    <path
      fill="#3b8739"
    ...
    />
    <path fill="#6da75d" d="m815 776.2 253.2 438.5L815 1360.9 561.9 922.4z" />
    <path fill="#55a344" d="m561.9 1214.8 86.9-141.8-86.9-150.6z" />
    <path fill="#639d57" d="m983.8 1068.6 84.4-146.2-253.1-146.1z" />
    <path
      fill="#333"
...
export { SvgComponent as NodeJSLogo }
